...
public class BytesUtil {
	...
	// Fluxo de bytes para string hexadecimal
	...
	// Um único caractere para byte
	private static byte charToByte(char c) {
		return (byte) "0123456789ABCDEF".indexOf(c);
	}

	//String hexadecimal para matriz de bytes
	...
	//String decimal para matriz de bytes
	@SuppressLint("DefaultLocale")
	...
	// Operação 1 de combinação de matriz de bytes
	...
	// Operação 2 de combinação de matriz de bytes
	...
	// Gerar fluxo de bytes da tabela
	...
	/**
	 *
	 * Gerar fluxo de bytes de código QR
	 *
	 * @param data
	 * @param size
	 * @return
	...
	public static byte[] getZXingQRCode(String data, int size) {
		try {
			...
			// Conversão de dados de imagem, usando conversão de matriz
	...
	/**
	 * Converte a imagem bitmap em um bitmap raster com largura e altura nos primeiros quatro bits
	 */
	...
	/**
	 * Converte bitmap em dados de linha de pontos N especificados por modo
	 */
	...
	/**
	 * Gerar dados intermitentes de bloco preto
	 * @param w : Largura do papel
	 * @return
	 */
	...
	/**
	 * Gere um grande bloco de dados pretos
	 * @param h : Altura do bloco preto, ponto unitário
	 * @param w : Largura do bloco preto, ponto unitário, múltiplo de 8
	 * @return
	 */
	...
	//Marca de linha divisória para impressão parcial de caracteres
